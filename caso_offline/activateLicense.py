...
def lambda_handler(event, context):
    ...
    col.insert_one({'hardware_id': hardware_id, 'app_type': app_type, 'license_key': license_key, 'expiration': expiration })
    
    client.close()
    
    license = f'{license_key};{hardware_id};{app_type};{expiration}'.encode()
